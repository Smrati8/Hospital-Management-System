<?php
	...
	$res = mysqli_query($conn, "select * from tbldoctor");
	$count = mysqli_num_rows($res);
?>
<!DOCTYPE html>
<html>
<head>
    <title>Appointment - KK Prashar Memorial Mother and Child Care Hospital</title>
  ...
  <body class="fixed-header">
            ...
            <!-- Collect the nav links, forms, and other content for toggling -->
              <div class="collapse navbar-collapse navbar-right medical-nav" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown active"><a href="appointment.php" class="dropdown-toggle"><i class="fa fa-plus"></i>Appointment</a></li>
    ...
    <div class="sub-page-content">
        ...
        <div class="container big-font">
        	<h2 class="light bordered main-title"><span>Appointment</span></h2>
            <p>Please fill the form below to get an appointment.</p>

			<div class="appointment-form clearfix">
			<div class="error" id="error" style="display:none;"></div>
			   <div class="success" id="message-app" style="display:none;"></div>
				<form name="appoint_form" id="appoint_form" method="post" onSubmit="return false">
					...
					<input type="text" name="patient_name" id="patient_name" placeholder="Name" onKeyPress="removeChecks();">
					<input type="email" name="patient_email" id="patient_email" placeholder="Email Address" onKeyPress="removeChecks();">
					<input type="text" name="patient_phone" id="patient_phone" placeholder="Phone No">
