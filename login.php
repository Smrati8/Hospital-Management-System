...
<html>
<head>
    <title>Login - KK Prashar Memorial Mother and Child Care Hospital</title>
  ...
  <body class="fixed-header">
            ...
            <!-- Collect the nav links, forms, and other content for toggling -->
              <div class="collapse navbar-collapse navbar-right medical-nav" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown active"><a href="login.php" class="dropdown-toggle"><i class="fa fa-plus"></i>Login</a></li>
                </ul>
              </div><!-- /.navbar-collapse -->
            </nav>
    ...
    <div class="sub-page-content">
        ...
        <div class="container big-font">
        	<h2 class="light bordered main-title"><span>User Login</span></h2>
            <p>Please fill the form below to login into your dashboard.</p>

			<div class="login-form clearfix">
			<div class="error" id="error" style="display:none;">kkkk</div>
			   <div class="success" id="message-login" style="display:none;">aaa</div>
				<form name="login_form" id="login_form" method="post" onSubmit="return false">
					<input type="text" name="email" id="email" placeholder="Email">
					<input type="password" name="password" id="password" placeholder="Password">
					<input type="submit" value="submit" class="btn btn-default btn-rounded" onClick="validateLogin();">
				</form>
			</div>
        </div>
